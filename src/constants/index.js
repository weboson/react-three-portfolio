...
const testimonials = [
  {
    testimonial:
      "Я думал, что невозможно сделать сайт таким же красивым, как наш продукт, но Ришат доказал, что я ошибался.",
    name: "Юлия",
    designation: "CFO",
    company: "Acme Co",
  ...
  {
    testimonial:
      "Я никогда не встречал веб-разработчика, который бы по-настоящему заботился об успехе своих клиентов так, как это делает Ришат.",
    name: "Виталий",
    designation: "COO",
    company: "DEF Corp",
  ...
  {
    testimonial:
      "После того, как Ришат оптимизировал наш сайт, наш трафик увеличился на 50%. Мы не можем достаточно их отблагодарить!",
    name: "Лиза",
    designation: "CTO",
