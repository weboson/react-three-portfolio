  ...
  return (
    <>
      ...
      <div className="w-full flex">
        ...
        >
          Последние проекты демонстрируют мои навыки и опыт на реальных
          примерах. Каждый проект кратко описан со ссылками на размещенный сайт
          и репозитории кода. Он отражает мою способность решать сложные
